...
use app\common\repositories\store\HomeImageRepository;
...
class Common extends BaseController
{
    ...
    public function home()
    {
        ...
        $category = app()->make(StoreCategoryRepository::class)->getOneLevel();
        $homeImg = app()->make(HomeImageRepository::class)->search();
        return app('json')->success(compact('banner', 'menu', 'hot', 'ad', 'category','homeImg'));
    }
