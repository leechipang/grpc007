...
Route::group('api/', function () {
    ...
    Route::group(function () {
        ...
        Route::group('user', function () {
            ...
            //用户绑定情况（是否满足绑定了身份证、手机号、真实姓名）
            Route::get('bind', 'User/bind');
            //用户绑定的信息
            Route::get('bindInfo', 'User/bindInfo');
            //绑定手机号和身份证和姓名
    ...
    //非强制登录
    Route::group(function () {
        Route::rule('testCheckUser','api.user.User/testCheckUser');
        //上传图片
...
//            Route::get('detail/:id', 'StoreProduct/detail');  //lizjun测试
