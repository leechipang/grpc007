...
export default {
  ...
  methods: {
    ...
    radioChange: function (e) {
      ...
      setAddressDefault(address.address_id)
        .then((res) => {
    ...
    editAddress: function (id) {
      ...
      uni.navigateTo({
        url:
          "/pages/users/user_address/index?id=" +
          id +
          "&cartId=" +
          cartId +
          "&pinkId=" +
    ...
    goOrder: function (id) {
      ...
      if (this.cartId && id) {
        ...
        if (this.type == 1) {
          uni.redirectTo({
            url:
              "/pages/users/order_confirm/index?is_address=1&cartId=" +
              cartId +
              "&addressId=" +
              id +
              "&pinkId=" +
          ...
          uni.redirectTo({
            url:
              "/pages/integral/submit?is_address=1&cartId=" +
              cartId +
              "&addressId=" +
              id +
              "&pinkId=" +
