<template>
  <view class="page-index" :class="{ bgf: navIndex > 0 }">
    ...
    <view class="header">
      <view class="serch-wrapper flex acea-row row-between-wrapper">
        ...
        >
          ...
          <text class="iconnum bg-color-red" v-if="userInfo.total_unread">{{
    ...
    >
          ...
          <block v-for="(item, index) in imgUrls" :key="index">
            <swiper-item :class="{ active: index == swiperCur }">
              ...
              >
                ...
                <!-- <image src="https://testp2p.tthweixin.com/uploads/def/20210315/103618aa937986f82c25f910b1a64fd5.png" class="slide-image"><image> -->
              </view>
            </swiper-item>
          </block>
        </swiper>
      ...
      <!-- menu -->
      <view class="nav acea-row t-acea-row" v-if="menus.length">
        ...
        <view class="seckill-count">
          <view class="spike-bd">
            ...
            <navigator
              ...
              class="more-btn"
              hover-class="none"
              >更多<text class="iconfont icon-jiantou" hover-class="none"></text
            ></navigator>
          </view>
          ...
          <view  class="combination_wrapper">
            <view class="spike-wrapper">
              <block class="acea-row row-between-wrapper combination">
                  ...
                  <view class="info">
                    <view class="price-box combination-price">
                      ...
                      <text class="gocom_btn"
                        >去拼团<text class="iconfont icon-jiantou"></text
                      ></text>
                    </view>
                  </view>
                  <view class="img-box">
                ...
                <view
                  v-if="combinationList.length == 1"
                  class="combination-item"
                  @click="goCombinDetail(combinationList[0])"
                >
                  <view class="info">
                    <view class="price-box combination-price">
                      <view class="name line1">{{
                      ...
                      <text class="price"
                        ><text>￥</text>{{ combinationList[0].price }}</text
                      >
                      <text class="gocom_btn"
                        >去拼团<text class="iconfont icon-jiantou"></text
                      ></text>
                  ...
                  <view class="img-box">
                    <image
                      :src="combinationList[0].product.image"
                      mode=""
                    ></image>
                  </view>
                </view>
                ...
                <view
                  v-if="combinationList.length == 2"
                  class="combination-item"
                  @click="goCombinDetail(combinationList[1])"
                >
                  <view class="info">
                    <view class="price-box combination-price">
                      <view class="name line1">{{
                      ...
                      <text class="price"
                        ><text>￥</text>{{ combinationList[1].price }}</text
                      >
                      <text class="gocom_btn"
                        >去拼团<text class="iconfont icon-jiantou"></text
                      ></text>
                  ...
                  <view class="img-box">
                    <image
                      :src="combinationList[1].product.image"
                      mode=""
                    ></image>
                  </view>
                </view>
          ...
          <view>
            ...
            <block>
              <view class="spike-bd">
                ...
                <navigator
                  url="/pages/activity/liveBroadcast/index"
                  class="more-btn"
                  hover-class="none"
                  >更多<text
                  ...
                  >
                    <navigator hover-class="none" :url="item.link">
                      ...
                      >
                        ...
                        <block
                          v-if="
                            item.live_status == 103 && item.replay_status === 1
                          "
                        >
                          <image
                            src="/static/images/live-02.png"
                            mode=""
                          ></image>
                          <text>回放</text>
                        </block>
            ...
            <view class="spike-wrapper">
              ...
              >
                <navigator
                  ...
                  :key="index"
                  :url="
                    '/pages/activity/presell_details/index?id=' +
                    item.product_presell_id
                  "
                  hover-class="none"
                >
          ...
          <view class="spike-bd">
            ...
            <view v-if="assistUserList.length > 0" class="activity_pic">
              <view v-for="(item, index) in assistUserList" class="picture">
                <span
                  class="avatar"
                  :style="'background-image: url(' + item.avatar_img + ')'"
                ></span>
                ...
                >
                  ...
                  <view class="assist-info">
                    <view class="price-box presell-price">
                      <view class="name line1">{{ item.store_name }}</view>
                      <text class="price"
                        ><text class="assist_price">助力价</text><text>￥</text
                        >{{ item.assistSku[0].assist_price }}</text
                      >
                    </view>
      ...
      <view class="main">
        ...
        <view class="hot-img" style="margin-top: 20rpx">
          ...
          >
            ...
            <view class="msg area-row" :style="'color:' + item.color + ';'">{{
              item.s_title
            }}</view>
            <view class="img">
        ...
        <!-- 积分商城 -->
        <view class="jifen clear" v-if="list1.length > 0">
          <view class="topp">
            <text class="tit">积分商城</text>
            <image class="pic" src="/static/img/1.png"></image>
            <view @click="go('/pages/integral/integral')" class="more">
              <text>查看更多</text>
          ...
          <ul class="list">
            ...
            >
              ...
              <view class="price">
                <image src="/static/img/20.png"></image>
                <text v-if="item.score > 0">{{ item.score }}</text>
                <text v-if="item.price != '0.00'">+￥{{ item.price }}</text>
              </view>
            </li>
          </ul>
        </view>
        <!-- 广告 -->
        <!-- <image class="nadd" src="/static/img/5.png"></image> -->
        <!-- 爆款热卖 -->
        <view v-if="list3.length > 0" style="padding-top: 20rpx" class="baok">
          <view
            @click="
              go(
                '/pages/columnGoods/goods_list/index?id=&title=&ppid=&is_hot=1'
              )
            "
            class="b-ad"
          >
            <image :src="bkPic"></image>
          </view>
          <swiper
            class="carousel"
            interval="3000"
            ...
            :autoplay="true"
            circular
            style="height: 776rpx; width: 712rpx; overflow: hidden"
            @change="navListChang1"
          >
            <swiper-item
              style="padding-top: 0upx;"
              class="carousel-item cate-section"
              v-for="(item, index) in list3"
              :key="index"
            >
              <ul class="list clear">
                <li
                  @click="goDet(item2.score, item2.product_id)"
                ...
                >
                  ...
                  <text class="name">{{ item2.store_name }}</text>
                  <view class="price clear">
                    <image
                      v-if="item2.score > 0"
                      src="/static/img/20.png"
                    ></image>
                    <text v-if="item2.score > 0">{{ item2.score }}</text>
                    <text v-if="item2.score > 0 && item2.price != '0.00'"
                      >+</text
                    >
                    <text v-if="item2.price != '0.00'"
                      >￥{{ item2.price }}</text
                    >
                  </view>
                </li>
        ...
        <!-- 新品上架 -->
        <view v-if="list4.length > 0" class="baok">
          <view
            @click="
              go(
                '/pages/columnGoods/goods_list/index?id=&title=&ppid=&is_new=1'
              )
            "
            class="b-ad"
          >
            <image :src="xpPic"></image>
          </view>
          <swiper
            class="carousel"
            interval="3000"
        ...
        <!-- 家居百货 -->
        <view v-for="(item, index) in list2" :key="index" class="baok">
          <view
            @click="
              go(
                '/pages/columnGoods/goods_list/index?id=&title=&ppid=' +
                  list5[index].categoryInfo.store_category_id
              )
            "
            class="b-ad"
          >
            <image :src="list5[index].categoryInfo.backImg"></image>
          </view>
          <swiper
            :id="index"
            class="carousel"
          ...
          >
            ...
            >
              <ul class="list clear">
                <li
                  @click="goDet(item3.score, item3.product_id)"
                ...
                >
                  ...
                  <text class="name">{{ item3.store_name }}</text>
                  <view class="price clear">
                    <image
                      v-if="item3.score > 0"
                      src="/static/img/20.png"
                    ></image>
                    <text v-if="item3.score > 0">{{ item3.score }}</text>
                    <text v-if="item3.score > 0 && item3.price != '0.00'"
                      >+</text
                    >
                    <text v-if="item3.price != '0.00'"
                      >￥{{ item3.price }}</text
                    >
                  </view>
                </li>
          ...
          <ul class="dian">
            <li
              :class="list6[index] == index4 ? 'sel' : ''"
              v-for="(item4, index4) in item"
              :key="index4"
            ></li>
          </ul>
        </view>
        <!-- 家居 -->
        <!-- <ul v-if="list2.length > 0" class="jiaju"> -->
        <ul v-if="false" class="jiaju">
          <li class="det" v-for="(item, index) in list2" :key="index">
            <view>
              <text
                style="opacity: 0"
                @click="
                ...
                "
                class="bgt"
                >{{ list5[index].categoryInfo.cate_name }}</text
              >
              <image
                @click="
                  go(
                ...
                "
                class="bgi"
                :src="list5[index].categoryInfo.backImg"
              ></image>
              <swiper
                class="carousel"
                interval="3000"
                ...
                :autoplay="true"
                :indicator-dots="true"
                indicator-active-color="#E04B4B"
                indicator-color="#BCBCBC"
                circular
                style="height: 850rpx; width: 716rpx; overflow: hidden"
                @change="navListChang2"
              >
                <swiper-item
                  style="padding-top: 0upx"
                ...
                >
                  <ul class="list clear">
                    ...
                    >
                      ...
                      <text class="name">{{
                        item3.store_name | string(4)
                      }}</text>
                      <view style="height: 60rpx" class="price clear">
                        <image
                          v-if="item3.score > 0"
                          src="/static/img/20.png"
                        ></image>
                      ...
                      <!-- <text class="price">￥{{ item3.price }}</text> -->
                    </li>
                  </ul>
                </swiper-item>
              </swiper>
            ...
            >
              <view class="mer-hd" @click="goStore(item.mer_id)">
                ...
                <view class="mer-name">
                  ...
                  <text v-if="item.is_trader" class="font-bg-red ml8"
                    >自营</text
                  >
                </view>
              </view>
              <view class="pro-box">
                ...
                >
                  ...
                  <view class="price"> <text>￥</text>{{ itemn.price }} </view>
                </navigator>
              </view>
            </view>
        ...
        <!-- 首页推荐 -->
        <view v-if="true" class="index-product-wrapper">
          <!-- 首发新品 -->
          <recommend
          ...
          <view
            ...
            v-if="hostProduct.length > 0"
          >
            <text
              class="loading iconfont icon-jiazai"
              :hidden="hotLoading == false"
            ></text
            >{{ hotTitle }}
          </view>
        </view>
    ...
    >
      <!-- <view
        class="sort acea-row"
        :class="sortList.length ? '' : 'no_pad'"
        :style="{ marginTop: sortMarTop + 'px' }"
      >
        <navigator
          hover-class="none"
          :url="
            '/pages/columnGoods/goods_list/index?id=' +
      ...
      <block v-if="sortProduct.length > 0">
        <view class="list acea-row row-between-wrapper">
          <navigator
            :url="
              item.score > 0
                ? `/pages/integral/product?id=${item.product_id}`
                : `/pages/goods_details/index?id=${item.product_id}`
            "
            class="item"
            hover-class="none"
          ...
          >
            ...
            <view class="text">
              <view class="name line1"
                ><text v-if="item.merchant.is_trader" class="font-bg-red"
                  >自营</text
                >{{ item.store_name }}</view
              >

              <view class="acea-row row-middle">
                <view class="money font-color-red p-jifen">
                ...
                <text class="coupon font-color-red p-pri" v-if="item.issetCoupon"
                  >领券</text
                >
              </view>
            </view>
      ...
      <block v-if="sortProduct.length == 0 && show">
        <!-- <view style="width: 750rpx; height: 300rpx; background: #000"></view> -->
  ...
  methods: {
    ...
    setBk(list) {
      for (var i = 0; i < list.length; i++) {
        if (list[i].type == 1) {
          this.bkPic = list[i].pic;
        } else if (list[i].type == 2) {
          this.xpPic = list[i].pic;
        }
      }
    },
    homeScoreProduct() {
      ...
      categoryProduct()
        .then((res) => {
          if (res.status == 200) {
            ...
            this.list5 = JSON.parse(JSON.stringify(res.data));
            console.log(this.list5);

            for (var j = 0; j < this.list2.length; j++) {
              let arr = [];
              let list = this.list2[j].list;
              for (let i = 0, length = list.length; i < length; i += 6) {
    ...
    navListChang3(e) {
      ...
      this.list6[e.target.id] = e.detail.current;
      this.$forceUpdate();
      // this.index2 = e.detail.current;
      // console.log(this.index1);
    },
...
window.location.href = url
    ...
    goDet(score, id) {
      if (score > 0) {
        uni.navigateTo({
          url: "/pages/integral/product?id=" + id,
        });
      } else {
        uni.navigateTo({
      ...
      getLiveList({
        ...
        .then((res) => {
          ...
          that.liveList.forEach((val) => {
            val.link =
              (val.live_status == 103 && val.replay_status) ||
              val.live_status === 101 ||
              val.live_status === 102
    ...
    changeTab(e) {
      ...
      if (e.index > 0) {
        storeCategory({
          ...
          this.sortList =
            res.data.length > 9 ? res.data.splice(0, 9) : res.data;
          if (this.sortList.length > 0) {
            this.where.pid = "";
            this.where.ppid = e.pid;
    ...
    get_product_list: function () {
      ...
      getProductslist(that.where)
        .then((res) => {
          ...
          this.sortProduct.length > 0 ? (this.show = true) : (this.show = true);
