		...
		<view class="head">
			<view class="user-card">
				...
				<view class="num-wrapper">
					...
					<view class="num-item" @click="goMenuPage('/pages/integral/platform')">
		...
		<view class="wrapper">
			...
			<view class="user-menus" style="margin-top: 20rpx;">
				...
				<view class="menu-box" v-if="isLogin">
					...
					<navigator url="/pages/integral/integral" class="item" hover-class="none" v-if="is_promoter == 0 && extension_status == 1">
						<image src="/static/img/21.png"></image>
						<text>积分商城</text>
					</navigator>
				</view>
			</view>
