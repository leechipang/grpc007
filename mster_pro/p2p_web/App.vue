  ...
  onLaunch: function (option) {
    ...
    if (option.query.hasOwnProperty("scene")) {
      switch (option.scene) {
        ...
        case 1047:
          ...
          let val = that.$util.getUrlParams(
            decodeURIComponent(option.query.scene)
          );
    ...
    getconfig()
      .then((res) => {
        ...
        this.globalData.store_user_min_recharge =
          res.data.store_user_min_recharge;
