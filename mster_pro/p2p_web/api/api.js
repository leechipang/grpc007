 ...
 * 首页积分商品
 */
export function homeScoreProduct(data) {
    return request.get('p2p/homeScoreProduct', data, { noAuth: true });
}
/**
 * 首页分类商品
 */
export function categoryProduct(data) {
    return request.get('p2p/categoryProduct', data, { noAuth: true });
}
/**
 * 积分商品
 */
export function scoreProduct(data) {
    return request.get('p2p/scoreProduct', data, { noAuth: true });
}
/**
 * 兑换方式
 */
export function userScore(data) {
    return request.get('p2p/userScore', data, { noAuth: true });
}
/**
 * 兑换明细
 */
export function order(data) {
    return request.get('p2p/order', data, { noAuth: true });
}
/**
 * 兑换明细详情
 */
export function detail(data) {
    return request.get('p2p/detail/' + data, {}, { noAuth: true });
}
/**
 * 平台积分
 */
export function scoreArticle(data) {
    return request.get('p2p/scoreArticle', data, { noAuth: true });
}
/**
 * 获取绑定信息
 */
export function bindInfo(data) {
    return request.get('user/bindInfo', data, { noAuth: true });
}
/**
 * 获取绑定情况
 */
export function ubind(data) {
    return request.get('user/bind', data, { noAuth: true });
}