    ...
    <div>
        <div class="mt20 ml20">
            ...
            <el-button type="primary" icon="ios-cloud-upload-outline" class="ml10" @click="zh_uploadFile">{{videoLink ? '确认添加' : '上传视频'}}</el-button>
              <el-progress :percentage = "progress" :text-inside="true"  v-if="upload.videoIng"></el-progress>
    ...
    export default {
        ...
        methods: {
          ...
          uploads() {
            ...
            nowEditor.editor.execCommand('insertHtml', '<p><video src=\'' + this.formValidate.video_link + '\' controls=\'controls\'></video></p>')
