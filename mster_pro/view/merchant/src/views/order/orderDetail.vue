...
<!--            <div class="description-term">用户昵称：{{orderDatalist.user.nickname}}</div>-->
          ...
          <div class="acea-row">
            ...
            <div v-if="orderDatalist.order_type === 0" class="description-term">订单状态：{{ orderDatalist.status | orderStatusFilter }}</div>
            <div v-else class="description-term">订单状态：{{ orderDatalist.status | cancelOrderStatusFilter }}</div>
