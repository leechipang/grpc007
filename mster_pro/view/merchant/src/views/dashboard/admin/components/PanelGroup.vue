            ...
            <div class="card-panel-compared">
              ...
              <p>
                ...
                <span :class="{'isdecline':mainData.lastWeekRate.orderNum<0}">
                  {{ mainData.lastWeekRate.orderNum ? (mainData.lastWeekRate.orderNum*100*1000/1000).toFixed(2) : 0.00 }}%
                  <i />
                </span>
              </p>
            </div>
            ...
            <div class="card-panel-compared">
              ...
              <p>
                ...
                <span :class="{'isdecline':mainData.lastWeekRate.payPrice<0}">
                  {{ mainData.lastWeekRate.payPrice ? (mainData.lastWeekRate.payPrice*100*1000/1000).toFixed(2) : 0.00 }}%
                  <i />
                </span>
              </p>
            </div>
            ...
            <div class="card-panel-compared">
              ...
              <p>
                ...
                <span :class="{'isdecline':mainData.lastWeekRate.payUser<0}">
                  {{ mainData.lastWeekRate.payUser ? (mainData.lastWeekRate.payUser*100*1000/1000).toFixed(2) : 0.00 }}%
                  <i />
                </span>
              </p>
            </div>
            ...
            <div class="card-panel-compared">
              ...
              <p>
                ...
                <span :class="{'isdecline':mainData.lastWeekRate.visitNum<0}">
                  {{ mainData.lastWeekRate.visitNum ? (mainData.lastWeekRate.visitNum*100*1000/1000).toFixed(2) : 0.00 }}%
                  <i />
                </span>
              </p>
            </div>
            ...
            <div class="card-panel-compared">
              ...
              <p>
                ...
                <span :class="{'isdecline':mainData.lastWeekRate.likeStore<0}">
                  {{ mainData.lastWeekRate.likeStore ? (mainData.lastWeekRate.likeStore*100*1000/1000).toFixed(2) : 0.00 }}%
                  <i />
                </span>
              </p>
            </div>
