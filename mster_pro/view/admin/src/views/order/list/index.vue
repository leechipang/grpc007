          ...
          <el-form size="small" inline label-width="100px">
            <el-form-item label="订单状态：">
              <el-radio-group v-model="tableFrom.status" type="button" @change="getList(1)">
                <el-radio-button>全部 {{ '(' +orderChartType.all?orderChartType.all:0 + ')' }}</el-radio-button>
                <el-radio-button
                  label="1"
...
<!--              <el-button size="small" type="primary" @click="getExportFileList">导出已生成列表</el-button>-->
      ...
      >
        ...
        <el-table-column label="积分支付" min-width="100">
          <template slot-scope="scope">
...
<script>
import { orderListApi, chartApi, exportOrderApi, } from "@/api/order";
...
// import {exportOrderApi} from "../../../../../merchant/src/api/order";
export default {
  components: { detailsFrom, cardsData,fileList },
  data() {
    return {
      orderId: 0,
      tableData: {
