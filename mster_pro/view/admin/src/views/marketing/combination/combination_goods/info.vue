      ...
      <el-tab-pane label="商品规格" name="fourth">
        ...
        <span class="sp100">
          ...
          <template v-if="projectData.spec_type === 1">
            <el-table :data="ManyAttrValue" border class="tabNumWidth manyAttr">
              ...
              <el-table-column v-for="(item,iii) in attrValue" :key="iii" :label="formThead[iii].title" align="center" min-width="40">
                <template slot-scope="scope">
