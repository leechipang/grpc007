        ...
        <div class="container">
          <el-form :inline="true">
            ...
            <el-form-item label="商家名称：" class="mr10">
              <el-input v-model="tableFrom.mer_name"   placeholder="请输入商家名称" class="selWidth"  size="small">
...
<!--        <el-button size="small" type="primary" @click="onAdd">添加</el-button>-->
      ...
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="mini">
        ...
        <el-table-column prop="score" label="消耗积分" sortable min-width="100"/>
...
<script>
  import {
    merchantStateListApi,
    // merchantsCreateApi,
    // merchantsStatusApi,
    // merchantsUpdateApi,
    // merchantsDeleteApi
  } from "@/api/integralState";
  ...
  export default {
    ...
    methods: {
      ...
      getList(num) {
        ...
        merchantStateListApi(this.tableFrom)
          .then((res) => {
