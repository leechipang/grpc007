  ...
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="container">
          <el-form :inline="true">
            ...
            <el-form-item label="商家名称：" class="mr10">
              <el-input v-model="tableFrom.name"   placeholder="请输入商家名称" class="selWidth"  size="small">
                <el-button slot="append" icon="el-icon-search" size="small" @click="getList(1)"/>
              </el-input>
            </el-form-item>
            <el-form-item label="关键字搜索：" class="mr10">
              <el-input  v-model="tableFrom.keyword" placeholder="请输入积分商家姓名或者积分商家ID" class="selWidth" size="small">
                <el-button slot="append" icon="el-icon-search" size="small" @click="getList(1)"/>
              </el-input>
            </el-form-item>
      ...
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="mini">
        ...
        <el-table-column prop="name" label="积分商家名称" min-width="200"/>
        <el-table-column label="积分商家logo" min-width="80" prop="logo">
        ...
        <el-table-column label="IP地址白名单" min-width="300">
          <template slot-scope="scope">
            <div class="mb5 content_font">{{ scope.row.ip_list }}</div>
          </template>
        </el-table-column>
