					...
					<block v-for="(item,index) in history" v-if="userId != 0" :key="index">
						...
						<div class="item acea-row row-top" v-if="item.send_type == 0">
							...
							<div class="text">
								...
								<div class="acea-row">
									<!--退款订单链接-->
									<navigator v-if="item.msn_type === 6 && item.refundOrder && item.refundOrder.refund_order_id" :url="'/pages/admin/orderDetail/index?id='+item.refundOrder.refund_order_id" open-type="redirect">
