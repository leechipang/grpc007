			 ...
			 @scroll="scroll">
				<view id="past0">
					...
					<view class='wrapper'>
						...
						<view class='introduce'><text v-if="(storeInfo.merchant && storeInfo.merchant.is_trader)" class="font-bg-red bg">自营</text>{{storeInfo.store_name}}
						...
						<view class="store-info">
							...
							<view class="info">
								<view class="name">{{storeInfo.merchant.mer_name}}
									<text v-if="(storeInfo.merchant && storeInfo.merchant.is_trader)" class="font-bg-red ml8">自营</text></view>
