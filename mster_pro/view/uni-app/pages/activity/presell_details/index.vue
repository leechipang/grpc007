	...
	<view class="product-con">
			 ...
			 @scroll="scroll">
				<view id="past0">
					...
					<view class='wrapper'>
						...
						<view class='introduce'><text v-if="(storeInfo.merchant && storeInfo.merchant.is_trader)" class="font-bg-red bg">自营</text>{{presellInfo.store_name}}</view>
		...
		<view class='footer_count'>
			...
			<view class="acea-row row-between-wrapper footer" :class="presellInfo.presell_type === 2 ? 'noborder' : ''">
				<navigator hover-class="none" class="item" :url="`/pages/chat/customer_list/chat?mer_id=${storeInfo.mer_id}&uid=${uid}&productId=${storeInfo.product_id}&presellId=${id}`">
